...
plt.xlabel('cancellation/sieve operations in order of creation')
plt.ylabel('Composite and Prime Address Space')
...
plt.xlabel('cancellation/sieve operations in order of creation aka quantity')
plt.ylabel('Composite and Prime Address Space')
plt.title("Composite and Prime Distribution for A201804")
...
plt.xlabel('cancellation/sieve operations in order of creation')
plt.ylabel('Composite and Prime Address Space or Amplitude Space')
plt.title("Composite and Prime Distribution for A201804")
...
# Your sorted list of numbers
data = sorted((composite_address_list_11))
# Count frequencies
freq = Counter(data)
...
# Create the plot
plt.figure(figsize=(6, 12))  # Tall and narrow to emphasize vertical line

# Plot horizontal bars centered at x=0
for num, freq in zip(unique_numbers, frequencies):
    # Bar extends from -freq/2 to +freq/2 to center it
    plt.barh(num, freq, height=1, left=-freq/2, color='#36A2EB', edgecolor='#1A73E8', linewidth=0.5)

# Customize the plot
plt.axvline(x=0, color='black', linestyle='-', linewidth=1)  # Vertical line at x=0
plt.xlabel('Amplitude (Frequency)')
plt.ylabel('Number')
plt.title('Centered Frequency Representation of Numbers')
plt.grid(True, axis='x', linestyle='--', alpha=0.7)

# Adjust x-axis to show positive and negative for symmetry
max_freq = max(frequencies)
plt.xlim(-max_freq/2 - 0.5, max_freq/2 + 0.5)
...
################# VERTICAL STACK LIST COLOR ENHANCED #######################
...
# Create a colormap for intensity based on frequency
...
# Plot horizontal bars centered at x=0 with color intensity
for num, freq, color in zip(unique_numbers, frequencies, colors):
    # Bar extends from -freq/2 to +freq/2 to center it
    plt.barh(num, freq, height=1, left=-freq/2, color=color, edgecolor='black', linewidth=0.5)

# Customize the plot
plt.axvline(x=0, color='black', linestyle='-', linewidth=1)  # Vertical line at x=0
plt.xlabel('Amplitude (Frequency)')
plt.ylabel('Number')
plt.title('Centered Frequency Representation with Intensity')
plt.grid(True, axis='x', linestyle='--', alpha=0.7)
...
# Add a colorbar to show frequency mapping
