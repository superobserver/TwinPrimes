...
from collections import Counter  # Added for counting distances
...
amplitude_list_twin = [0]*int(limit+100)

def drLD(x, l, m, z, listvar):   
  "This is a composite generating function"
  global amplitude_list_twin
  new_count = 0
  y = 90*(x*x) - l*x + m
  if 0 <= y < len(listvar):
    listvar[y] += 1
    amplitude_list_twin[y] += 1    
...
amplitude_list_twin = amplitude_list_twin[:-100]
...
new1aa = amplitude_list_twin.count(0)
...
print("This is twin primes for A224854 aka class 11 and 13:", new1aa)

twin_address_list_A224854 = [i for i,x in enumerate(amplitude_list_twin) if x == 0]
...
print("This is class 13 membership divided by class 11 membership:", len(prime_address_list_11) / len(prime_address_list_13))
print("This is twin primes divided by 11 class", len(twin_address_list_A224854) / len(prime_address_list_11))
print("This is twin primes divided by 11 class", len(twin_address_list_A224854) / len(prime_address_list_11))
...
list1 = [x for x in twin_address_list_A224854 if x%9==1]
list2 = [x for x in twin_address_list_A224854 if x%9==2]
list3 = [x for x in twin_address_list_A224854 if x%9==3]
list4 = [x for x in twin_address_list_A224854 if x%9==4]
list5 = [x for x in twin_address_list_A224854 if x%9==5]
list6 = [x for x in twin_address_list_A224854 if x%9==6]
list7 = [x for x in twin_address_list_A224854 if x%9==7]
list8 = [x for x in twin_address_list_A224854 if x%9==8]
list9 = [x for x in twin_address_list_A224854 if x%9==0]
...
# New: Compute and plot distribution of consecutive distances (gaps) in prime_address_lists
if len(twin_address_list_A224854) > 1:
    diffs_11 = [twin_address_list_A224854[i+1] - twin_address_list_A224854[i] for i in range(len(twin_address_list_A224854)-1)]
    count_11 = Counter(diffs_11)
    print("Distance counts for class A224854:", sorted(count_11.items()))
    #print("The list of terms", diffs_11, "The list of gaps.") #uncomment to see list of gaps
else:
    print("Not enough primes in class 11 for distances.")
    count_11 = Counter()

if len(prime_address_list_13) > 1:
    diffs_13 = [prime_address_list_13[i+1] - prime_address_list_13[i] for i in range(len(prime_address_list_13)-1)]
    count_13 = Counter(diffs_13)
    print("Distance counts for class 13:", sorted(count_13.items()))
else:
    print("Not enough primes in class 13 for distances.")
    count_13 = Counter()

# Plot distributions as bar plots (distance vs count)
fig, axs = plt.subplots(2, 1, figsize=(10, 10))

if count_11:
    sorted_keys_11 = sorted(count_11.keys())
    axs[0].bar(sorted_keys_11, [count_11[k] for k in sorted_keys_11])
    axs[0].set_xlabel('Distance (Gap)')
    axs[0].set_ylabel('Frequency')
    axs[0].set_title('Distribution GAPS for Twin Primes')

if count_13:
    sorted_keys_13 = sorted(count_13.keys())
    axs[1].bar(sorted_keys_13, [count_13[k] for k in sorted_keys_13])
    axs[1].set_xlabel('Distance (Gap)')
    axs[1].set_ylabel('Frequency')
    axs[1].set_title('Distribution of GAPS for Class 13 Primes')
